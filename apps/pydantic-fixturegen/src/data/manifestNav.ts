...
export const manifestNav: ManifestNavItem[] = [
  ...
  { title: 'Command guides', path: 'commands/index.md',
    children: [
      { title: 'Discovery & auditing', path: 'commands/pfg-list.md',
        children: [
      ...
      { title: 'Generation', path: 'commands/pfg-gen-json.md',
        children: [
      ...
      { title: 'Integrations & sanitization', path: 'commands/pfg-anonymize.md',
        children: [
      ...
      { title: 'Pipelines & CI', path: 'commands/pfg-diff.md',
        children: [
      ...
      { title: 'Project setup', path: 'commands/pfg-init.md',
        children: [
  ...
  { title: 'Generation internals', path: 'discovery.md',
    children: [
  ...
  { title: 'Quality + testing', path: 'doctor.md',
    children: [
